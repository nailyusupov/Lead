                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="margin-top: 25px;">
                                <div class="panel panel-info">
                                    <div class="panel-body" style="background-color: #fcf8e3;">
                                        <h1 style="margin-bottom: 25px;"><i class="fa fa-address-card-o"></i> ${data.getName()}</h1>
                                        ...
                                        <div class="row" style="padding-bottom: 10px;">
                                            <label class="col-sm-3 control-label">${data.getBusinessLabel()}</label>
                                            <div class="col-sm-9">
                                                <span style="font-size: 14pt;">${data.getBusinessName()}</span>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-bottom: 10px;">
